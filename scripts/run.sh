...
echo "compile dpi-c"
gcc -c -I$include_dir -fPIC ../src_c/SumClass.cc -o SumClass.o
gcc -c -I$include_dir -fPIC ../src_c/SumClass_dpi.cc -o SumClass_dpi.o
...
#gui mode
#vsim $vlib_dir/work.testbench -sv_lib $vlib_dir/SumClass -t ns -do "set NoQuitOnFinish 1" -do wave.do -do "run -all"